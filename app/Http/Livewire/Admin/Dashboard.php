...
class Dashboard extends Component
{
    ...
    public function render()
    {
        ...
        $this->vetor_totais[0] = Registoentrada::where('tipo_processo_id', 1)
            ->where('estado', 'pendente')
            ->count();

        $this->vetor_totais[1] = Advogado::where('categoria', 'Advogado')->count();
        $this->vetor_totais[2] = Advogado::where('categoria', 'Estagiario')->count();
