        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            <li class="menu active">
                ...
                <ul class="dropdown-menu submenu list-unstyled" id="dashboard" data-bs-parent="#accordionExample">
                    <li class="active">
                        <a href="{{ route('system.admin.dashboard') }}"> Resumo Website </a>
                    </li>
                    <li class="active">
                        <a href="{{ route('system.admin.dashboard_system') }}"> Resumo Sistema </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="dropdown-menu submenu list-unstyled" id="apps" data-bs-parent="#accordionExample">
                    <li>
                        <a href="{{route('system.admin.listnoticia')}}"> Notícias </a>
                    </li>
                    <li>
                        <a href="{{route('system.admin.listgaleria')}}"> Imagens Galeria </a>
                    </li>
                    <li>
                        <a href="{{route('system.admin.listmessages', 'not-solved')}}"> Mensagens</a>
                    </li>
                    <li>
                        <a href="{{route('system.admin.listdenuncias', 'not-solved')}}"> Reclamações</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="dropdown-menu submenu list-unstyled" id="components" data-bs-parent="#accordionExample">
                    <li>
                        <a href="{{route('system.admin.list_trainees')}}"> Estagiários </a>
                    </li>
                    <li>
                        <a href="{{route('system.admin.list_lawyers')}}"> Advogados </a>
                    </li>
                    <li>
                        <a href="{{route('system.admin.list_undefined')}}"> Por Especificar </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="dropdown-menu submenu list-unstyled" id="components" data-bs-parent="#accordionExample">
                    <li>
                        <a href="{{route('system.admin.new_user')}}"> Novo Usuário </a>
                    </li>
                    <li>
                        <a href="{{route('system.admin.listusuario')}}"> Listar Funcionarios </a>
                    </li>
                    <li>
                        <a href="{{route('system.admin.listassociados')}}"> Listar Associados </a>
                    </li>
                </ul>
            </li>
        </ul>
