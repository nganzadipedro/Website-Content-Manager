                    ...
                    @if (Auth::user()->permissao_id == 3)
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                <div class="dropdown-menu-columns">
                                    <div class="dropdown-menu-column">
                                        <a class="dropdown-item" href="{{ route('system.areatecnica.list_cerimonia','Advogado') }}">
                                            Advogados
                                        </a>
                                        <a class="dropdown-item" href="{{ route('system.areatecnica.list_cerimonia','Estagiario') }}">
                                            Advogados Estagiários
                                        </a>
                                    </div>
                                </div>
