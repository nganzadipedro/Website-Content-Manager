<div class="page-wrapper">
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-10">
                            ...
                            <a id="btn-registar-dataentrega" class="btn btn-info">
                                ...
                                </svg> Registar Data de Entrega</a>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($lista as $item)
                                        <tr>
                                            ...
                                            <td>{{$item->data_levantamento_distribuicao == null ? 'Não definida' : $item->data_levantamento_distribuicao}}
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Registar Data de Entrega ao Conselheiro</h5>
                ...
                <div class="modal-footer">
                    <div class="col-lg-12 col-12">
                        <a id="btn-salvar-dataentrega" class="btn btn-success mt-4">Salvar</a>
                        <a id="btn-cancelar-dataentrega" class="btn btn-danger mt-4">Cancelar</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal modal-blur fade" id="modal-remeter-comissao-etica" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
