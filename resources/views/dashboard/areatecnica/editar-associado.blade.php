                    ...
                    <div class="col-12">
                        <form action="https://httpbin.org/post" method="post" class="card">
                            ...
                            <div class="card-body">
                                ...
                                <input type="hidden" value="{{ $advogado->categoria }}" name="categoria_field" id="categoria_field">
                                            ...
                                            <div class="col-lg-6 col-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" maxlength="200" name="nome_completo"
                                                        class="form-control" id="nome_completo" value="{{ $pessoa->nome }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6 col-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" maxlength="200" name="nome_profissional"
                                                        class="form-control" id="nome_profissional" value="{{ $advogado->nome_profissional }}">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-3 col-12 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" maxlength="9" name="telefone1"
                                                        class="form-control" id="telefone1" value="{{ $pessoa->telefone1 }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3 col-12 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" maxlength="9" name="telefone2"
                                                        class="form-control" id="telefone2" value="{{ $pessoa->telefone2 }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3 col-12 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" maxlength="9" name="num_associado"
                                                        class="form-control" id="num_associado" value="{{ $advogado->num_associado }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3 col-12 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" maxlength="9" name="num_estagiario"
                                                        class="form-control" id="num_estagiario" value="{{ $advogado->num_estagiario }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3 col-12 col-md-3 col-sm-12 col-xl-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="data_inscricao_oaa" class="form-control"
                                                        id="data_inscricao_oaa" value="{{ $advogado->data_inscricao_oaa }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-12 col-md-3 col-sm-12 col-xl-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="data_inscricao_estagiario"
                                                        class="form-control" id="data_inscricao_estagiario" value="{{ $advogado->data_inscricao_estagiario }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-12 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="categoria" id="categoria" class="form-control">
                                                        <option value="">Selecione...</option>
                                                        <option {{ $advogado->categoria == 'Advogado' ? 'selected' : '' }} value="Advogado">Advogado</option>
                                                        <option {{ $advogado->categoria == 'Estagiario' ? 'selected' : '' }} value="Estagiario">Estagiario</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-lg-6 col-12 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" maxlength="200"
                                                            id="endereco_profissional_adv" name="endereco_profissional_adv" value="{{ $advogado->endereco_escritorio }}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-12 col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="municipio_id_adv" id="municipio_id_adv"
                                                            ...
                                                            @foreach ($municipios as $muni)
                                                                <option {{ $muni->id == $advogado->municipio_id ? 'selected' : '' }} value="{{$muni->id}}">{{$muni->descricao}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-lg-6 col-12 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" maxlength="200"
                                                            id="nome_patrono" name="nome_patrono" value="{{ $advogado->nome_patrono }}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-12 col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" maxlength="200"
                                                            id="tel_patrono" name="tel_patrono" value="{{ $advogado->telefone_patrono }}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-12 col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" class="form-control" maxlength="200"
                                                            id="email_patrono" name="email_patrono" value="{{ $advogado->email_patrono }}">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-lg-3 col-12 col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" maxlength="200"
                                                            id="nome_escritorio" name="nome_escritorio" value="{{ $advogado->nome_escritorio }}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-12 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" maxlength="200"
                                                            id="endereco_escritorio_est" name="endereco_escritorio_est" value="{{ $advogado->endereco_escritorio }}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-12 col-md-3">
                                                    <div class="form-group">
