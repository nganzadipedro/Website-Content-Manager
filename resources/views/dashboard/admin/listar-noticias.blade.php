                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-10">
                            ...
                            <div class="mt-3">
                                <a href="{{ route('cadnoticia') }}" class="btn btn-info"
                                    rel="noopener">Cadastrar nova notícia</a>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            <table id="zero-config" class="table card-table table-vcenter text-nowrap datatable">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>ID</th>
