document.addEventListener('DOMContentLoaded', () => {
    // Configurar slider
    const slider = document.getElementById('commission-guarantees-slider');
    ...
    // Criar indicadores (dots) apenas em telas menores para esta seção
    const createDots = () => {
        if (window.innerWidth <= 992) {
            ...
            dotsContainer.innerHTML = ''; // Remove dots em telas grandes
        }
    };
    ...
    const updateSlider = () => {
        ...
        // Atualizar indicadores apenas se os dots existirem
    ...
    // Ajustar número de itens por visualização e dots com base no tamanho da tela
    const updatePerView = () => {
        ...
        if (perView !== prevPerView) {
            ...
            createDots(); // Recria os dots com base na largura da tela
