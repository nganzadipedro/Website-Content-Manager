...
document.getElementById('btn-salvar').addEventListener('click', function () {
    ...
    if (valida_formulario() === true) {
        ...
        Swal.fire({
            title: "Confirmação",
            text: "Tem certeza que deseja actualizar esta notícia? Em caso afirmativo, clique em Actualizar e aguarde a conclusão do processo de actualização",
            icon: "warning",
            ...
            preConfirm: function () {
                return $.ajax({
                    url: "/system/admin/newslater/update",
                    headers: {
