...
$(document).on('click', '.delete-news', function (e) {
    ...
    Swal.fire({
        title: "Confirmação",
        text: "Tem certeza que deseja eliminar esta notícia? Em caso afirmativo, clique em Eliminar e aguarde a conclusão do processo de exclusão",
        icon: "warning",
                ...
                success: function (res) {
                    ...
                    if (res == 'sucesso') {
                        sweetAlert({
                            type: "success",
                            title: "Sucesso",
                            text: 'A notícia foi eliminada com sucesso',
                            timer: 6000
                        });
                        location.reload();
                    }
