    ...
    fetch(`/system/getAdvogadoById/${id}`)
        ...
        .then(data => {
            ...
            html = `<div class="col-md-12 col-lg-12 col-xl-12 col-12">
                            ...
                            Data de Inscrição Estagiário: ${data.data_inscricao_estagiario} <br><br>
                            Nome do patrono: ${data.nome_patrono} <br><br>
                            Telefone do patrono: ${data.telefone_patrono} <br><br>
                            Email do patrono: ${data.email_patrono} <br><br>
                            Nome do escritório: ${data.nome_escritorio} <br><br>
                            Endereço do escritório: ${data.endereco_escritorio}
                        </div>`
